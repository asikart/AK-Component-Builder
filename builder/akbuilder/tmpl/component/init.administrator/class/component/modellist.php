...
class AKModelList extends JModelList
{
	...
	public function getFilter()
	{
		...
		JForm::addFormPath(AKComponentHelper::_('path.get').'/models/forms');
        JForm::addFieldPath(AKComponentHelper::_('path.get').'/models/fields');
		...
		if( JVERSION >=3 && $this->config['core_sidebar'] ) {
			...
			$file 	= AKComponentHelper::_('path.get').'/models/forms/'.$this->list_name.'_filter.xml' ;
	...
	{
		$file = AKComponentHelper::_('path.get').'/models/forms/'.$this->list_name.'_search.xml' ;
