...
class AKComponentHelperInclude
{
	static $bootstrap ;
	static $bluestork ;
	...
	{
		$files 	= JFolder::files(AKComponentHelper::_('path.get', $client).'/'.$path, ".css$", true);
		$doc 	= JFactory::getDocument();
		$option = JRequest::getVar('option') ;
		...
		foreach( $files as $key => $file ):
			...
			if( is_numeric( array_shift( $name ) ) ) {
				$doc->addStylesheet( AKComponentHelper::_('uri.component').'/'.$path.'/'.$file ) ;
			}
		endforeach;
	}
