...
class AKComponentHelperLang {
	...
	{
		$files 	= JFolder::files(AKComponentHelper::_('path.getAdmin').'/language/'.$lang);
		...
		foreach( $files as $file ):
			...
			$lang->load(implode('.', $file), AKComponentHelper::_('path.getAdmin')) ;
		endforeach;
	}
}
