...
class {COMPONENT_NAME_UCFIRST}HelperInclude
{
	...
	{	
		...
		if( $js && JVERSION < 3 ){
			JHtml::_('script', $prefix.'components/com_{COMPONENT_NAME}/includes/bootstrap/js/jquery.js');
			JHtml::_('script', $prefix.'components/com_{COMPONENT_NAME}/includes/bootstrap/js/bootstrap'.$min.'.js');
