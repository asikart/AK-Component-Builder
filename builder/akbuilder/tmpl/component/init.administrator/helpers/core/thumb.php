...
define('{COMPONENT_NAME_UC}_THUMBCACHE_PATH', 	JPath::clean(JPATH_CACHE.'/'.$params->get('thumb_cache_path', 'cache/thumbs/cache')) ) ;
define('{COMPONENT_NAME_UC}_THUMBCACHE_URL', 	JURI::root().$params->get('thumb_cache_path', 'cache/thumbs/cache' ) ) ;

define('{COMPONENT_NAME_UC}_THUMBTEMP_PATH', 	JPath::clean(JPATH_CACHE.'/'.$params->get('thumb_temp_path', 'cache/thumbs/temp')) ) ;
define('{COMPONENT_NAME_UC}_THUMBTEMP_URL', 		JURI::root().$params->get('thumb_temp_path', 'cache/thumbs/temp') ) ;


class {COMPONENT_NAME_UCFIRST}HelperThumb
{
	
	public static $cache_path 	= {COMPONENT_NAME_UC}_THUMBCACHE_PATH ;
	
	public static $cache_url 	= {COMPONENT_NAME_UC}_THUMBCACHE_URL ;
	
	public static $temp_path 	= {COMPONENT_NAME_UC}_THUMBTEMP_PATH ;
	
	public static $temp_url		= {COMPONENT_NAME_UC}_THUMBTEMP_URL ;
	...
	public static function getImagePath($url, $hash=null)
	{
		...
		if( $self->getHost() == $url->getHost() ){
			...
			if( !JFile::exists( $path ) ){
				{COMPONENT_NAME_UCFIRST}Helper::_('curl.getFile', (string)$url, $path);
			}
		}
