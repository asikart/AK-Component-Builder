...
class {COMPONENT_NAME_UCFIRST}View{CONTROLLER_NAMES_UCFIRST} extends AKView
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_{COMPONENT_NAME_UC}_TITLE_{CONTROLLER_NAME_UC}S'), '{CONTROLLER_NAMES}.png');
        ...
        if (file_exists($formPath)) {
		    ...
		    if ($canDo->get('core.edit')) {
			    ...
			    JToolBarHelper::deleteList('', '{CONTROLLER_NAMES}.delete');
		    }
        }
