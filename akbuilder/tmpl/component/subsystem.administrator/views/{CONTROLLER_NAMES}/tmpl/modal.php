...
<form action="<?php echo $uri = JFactory::getURI()->toString() ; ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminlist table table-striped">
        ...
        <?php foreach ($this->items as $i => $item) :
            ...
            $canCheckin = $user->authorise('core.edit.state',   'com_{COMPONENT_NAME}.{CONTROLLER_NAME}.'.$item->a_id) || $item->a_checked_out == $userId || $item->a_checked_out == 0;;
            $canChange  = $user->authorise('core.edit.state',   'com_{COMPONENT_NAME}.{CONTROLLER_NAME}.'.$item->a_id) && $canCheckin;
            $canEditOwn = $user->authorise('core.edit.own',     'com_{COMPONENT_NAME}.{CONTROLLER_NAME}.'.$item->a_id) && $item->a_created_by == $userId;
