...
/**
 * Class {COMPONENT_NAME_UCFIRST}View{CONTROLLER_NAMES_UCFIRST}Html
 *
 * @since 1.0
 */
class {COMPONENT_NAME_UCFIRST}View{CONTROLLER_NAMES_UCFIRST}Html extends ListHtmlView
{
	/**
	 * prepareData
	 *
	...
	protected function prepareData()
	{
		...
		if ($active)
		{
			...
			if (!strpos($currentLink, 'view={CONTROLLER_NAMES}') || !(strpos($currentLink, 'id=' . (string) $data->category->id)))
			{
