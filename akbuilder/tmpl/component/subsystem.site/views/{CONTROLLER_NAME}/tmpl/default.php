...
{COMPONENT_NAME_UCFIRST}Helper::_('include.bootstrap', true, true);
            ...
            <div class="{CONTROLLER_NAME}-item item<?php if($item->published == 0) echo ' well well-small'; ?>">
                <div class="{CONTROLLER_NAME}-item-inner">
                    ...
                    <div class="edit-icon btn-toolbar fltrt">
                        <div class="btn-group">
                            <?php echo JHtml::_('link', JRoute::_('index.php?option=com_{COMPONENT_NAME}&task={CONTROLLER_NAME}.edit&id='.$item->id.'&return=' . {COMPONENT_NAME_UCFIRST}Helper::_('uri.base64', 'encode', $uri->toString())) ,JText::_('JTOOLBAR_EDIT'), array( 'class' => 'btn btn-small')); ?>
                            <button class="btn btn-small dropdown-toggle" data-toggle="dropdown">
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="jgrid" href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $item->id; ?>','{CONTROLLER_NAMES}.publish')" title="<?php echo JText::_('JTOOLBAR_ENABLE'); ?>"><?php echo JText::_('JTOOLBAR_ENABLE'); ?></a>
                                </li>
                                <li>
                                    <a class="jgrid" href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $item->id; ?>','{CONTROLLER_NAMES}.unpublish')" title="<?php echo JText::_('JTOOLBAR_DISABLE'); ?>"><?php echo JText::_('JTOOLBAR_DISABLE'); ?></a>
                                </li>
                            </ul>
                          </div>
